<template>
  <div class="container">
      ...
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <g id="Background_Simple" style="display:none;">
          <g style="display:inline;">
            <path style="fill:#0009;" d="M401.846,174.319c-6.792,54.216-54.298,108.35-106.533,143.215
        ...
        <g id="Login">
          <g>
            <polygon style="fill:#0009;" points="249.96,361.048 107.96,361.048 100.188,132.681 242.188,132.681 		"/>
            <g>
              <polygon style="fill:#0009;" points="257.047,353.961 115.047,353.961 107.274,125.594 249.274,125.594 			"/>
              <polygon style="opacity:0.3;fill:#FFFFFF;" points="257.047,353.961 115.047,353.961 107.274,125.594 249.274,125.594 			"/>
            </g>
            <g>
              
                <ellipse transform="matrix(0.7011 -0.7131 0.7131 0.7011 -82.3091 185.8367)" style="fill:#0009;" cx="180.503" cy="191.093" rx="39.269" ry="40.629"/>
              ...
              <path style="opacity:0.6;fill:#0009;" d="M210.019,206.792c-5.211,10.275-15.862,17.263-28.395,17.263
                ...
                <ellipse transform="matrix(0.7011 -0.7131 0.7131 0.7011 -74.3786 182.1882)" style="opacity:0.6;fill:#0009;" cx="180.119" cy="179.811" rx="14.437" ry="14.937"/>
            </g>
            ...
            <path style="fill:#0009;" d="M194.658,287.908l-21.829,2.968c-0.897,0.122-1.487,0.939-1.317,1.807l2.866,14.628
            ...
            <path style="fill:#0009;" d="M192.504,287.124L192.504,287.124c-0.798,0.108-1.568-0.434-1.72-1.211l-0.281-1.432
            ...
            <polygon style="fill:#0009;" points="214.667,328.639 155.703,328.639 155.305,316.922 214.268,316.922 		"/>
        ...
        <g id="Character_1_">
          <g>
            ...
            <path style="fill:#0009;" d="M320.542,170.833c0.936-1.326,0.899-5.515-0.101-6.254c-1.614-1.193-8.517-1.467-17.816,0.671
              c1.001,4.058-1.143,6.185-1.143,6.185L320.542,170.833z"/>
            <path style="fill:#0009;" d="M351.795,408.237c-0.706,0.153-1.411,0.193-1.751-0.096c-0.143-0.122-0.286-0.354-0.161-0.774
            ...
            <path style="fill:#0009;" d="M353.509,407.668c-0.027,0.006-0.055,0.005-0.082-0.003c-0.795-0.232-2.496-1.441-2.517-2.238
            ...
            <path style="fill:#0009;" d="M299.865,409.417c-0.903,0-1.775-0.124-2.067-0.53c-0.102-0.142-0.183-0.384,0.014-0.728
            ...
            <path style="fill:#0009;" d="M301.989,409.223c-0.023,0-0.046-0.005-0.068-0.015c-0.849-0.381-2.531-1.902-2.402-2.698
            ...
            <g>
              <path style="fill:#0009;" d="M331.167,168.982c6.592,1.511,12.028,18.341,12.028,18.341l-13.238,10.09
            ...
            <g>
              <path style="fill:#0009;" d="M289.508,176.035c-1.438,7.599-2.338,23.203,1.837,54.105h37.621
            ...
            <path style="fill:#0009;" d="M304.69,230.14c0,0,7.982,53.753,12.365,73.891c4.799,22.053,30.531,95.014,30.531,95.014
            ...
            <path style="fill:#0009;" d="M291.345,230.14c0,0-0.969,52.59-0.204,74.039c0.796,22.311,8.589,95.363,8.589,95.363h11.915
            ...
            <g>
              <path style="fill:#0009;" d="M304.252,178.342c3.373,9.089-16.442,19.795-16.442,19.795l-8.578-11.028
        ...
        <g id="Thinking">
          <g>
            <ellipse style="fill:#0009;" cx="381.875" cy="86.333" rx="36.087" ry="23"/>
            ...
            <ellipse style="opacity:0.6;fill:#0009;" cx="352.495" cy="115.258" rx="11.861" ry="7.56"/>
            <ellipse style="opacity:0.3;fill:#0009;" cx="333.629" cy="122.817" rx="4.869" ry="3.103"/>
          </g>
        </g>
      </svg>
    </div>
    ...
    <div class="resetPassword-form">
      <input v-model="resetPassword" type="password" placeholder="密碼" @blur="validatePassword(resetPassword)" @input="clearError" :class="{ 'error': resetPasswordError }"/>
      <span v-if="resetPasswordError" class="error">{{ resetPasswordError }}</span>
      <input v-model="resetConfirmPassword" type="password" placeholder="確認密碼" @blur="validateConfirmPassword(resetPassword, resetConfirmPassword)" @input="clearError" :class="{ 'error': resetConfirmPasswordError }"/>
      <span v-if="resetConfirmPasswordError" class="error">{{ resetConfirmPasswordError }}</span>
    </div>
    <div class="form--btn">
      <button @click="changePassword">密碼重設</button>
    </div>
  </div>
</template>
...
import { fetchResetPassword } from '@/api/index';
...
const validatePassword = (password) => {
  ...
  resetPasswordError.value = passwordPattern.test(password) ? '' : '密碼必須包含6-20個字符，且至少包含一個大寫字母、一個小寫字母和一個符號';
};

const validateConfirmPassword = (password, confirmPassword) => {
  resetConfirmPasswordError.value = password === confirmPassword ? '' : '密碼不匹配';
};

const changePassword = () => {
  if (!resetPasswordError.value && !resetConfirmPasswordError.value) {
    fetchResetPassword({'encodingParameter': token , 'newPassword': resetPassword.value})
    .then(res => {
      userStore.isAlertMessagesShow({visible: true, message: '更換密碼成功！', status: true});
      setTimeout(() => {
        router.replace('/').then(() => {
